...
//IMAGE
  ...
  void enviar() async{
    ...
    StorageReference ref = FirebaseStorage.instance.ref().child(path.basename(widget.imagem.path));
    StorageUploadTask uploadTask = ref.putFile(widget.imagem);
...
//IMAGE
    ...
    var data = {
      "image": url,
      "nomeDaArvore": widget.NomeDaArvore,
    ...
    Firestore.instance.runTransaction((Transaction transaction) async {
      _firestore.collection('Aguardando')
          .add(
          data);
    });
  }
